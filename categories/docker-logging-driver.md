...
<pre class="CodeRay">
  <span class="comment">$</span><span class="function"> fluentd -c in_docker.conf
</span></pre>
...
<pre class="CodeRay">
  <span class="comment">$</span><span class="function"> docker run --log-driver=fluentd ubuntu echo "Hello Fluentd!"
...
<pre class="CodeRay">
  <span class="string">2015-09-01 15:10:40 -0600 docker.3fd8678d487e: {"source":"stdout","log":"Hello Fluentd!","container_id":"3fd8678d487e540c7a303e1613101e746c5012f3317434eda93f24351c1928f7","container_name":"/angry_kalam"}
</span></pre>
...
<pre class="CodeRay">
  <span class="tag">&lt;filter</span> <span class="attribute-name">docker.</span><span class="error">*</span><span class="error">*</span><span class="tag">&gt;</span>
  @type parser
...
<pre class="CodeRay">
  <span class="comment">$</span><span class="function"> docker run --log-driver=fluentd --log-opt fluentd-address=192.168.2.4:24225 ubuntu echo "..."
</span></pre>
<h4>tag</h4>
...
<pre class="CodeRay">
  <span class="comment">$</span><span class="function"> docker run --log-driver=fluentd --log-opt tag=docker.my_new_tag ubuntu echo "..."
</span></pre>
...
<pre class="CodeRay">
  <span class="comment">$</span><span class="function"> docker run --log-driver=fluentd --log-opt tag=docker.{{"{{.ID"}}}} ubuntu echo "..."
</span></pre>
