...
Fluentd is maintained continuously and releases it periodically, follow [official blog announcement](https://www.fluentd.org/blog/tag/announcement) with `announcement` tag.
