...
![](../.gitbook/assets/fluentd-norikra-overview%20%281%29%20%281%29.png)
...
The **norikra** attribute specifies the Norikra server's RPC host and port \('26571' is the default port of Norikra RPC protocol\). By **target\_map\_tag true** and **remove\_tag\_prefix data**, out\_norikra handle the rest of tags \(ex: 'foo' for 'data.foo'\) as target, which is a name of set of events as same as table name of RDBMS.
